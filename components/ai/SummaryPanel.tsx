...
export function SummaryPanel() {
  ...
  return (
    <GlowCard glowColor="rgba(139, 92, 246, 0.08)" className="p-4 flex flex-col justify-between h-full bg-zinc-950/40 border-white/5">
      <div>
        {/* Header */}
        ...
        <div className="space-y-3">
          <div>
            <h4 className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Summary</h4>
            <p className="text-xs text-zinc-300 mt-1 leading-relaxed bg-zinc-900/40 p-2.5 rounded-lg border border-white/5 font-light">
          ...
          {/* Bullet highlights */}
          <div>
            <h4 className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1.5">Key Highlights</h4>
      ...
      <div className="border-t border-white/5 pt-3 mt-4 space-y-2">
        <h4 className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">AI Next Step</h4>
        ...
        {activeConversation.urgencyScore > 75 ? (
          ...
          <div className="flex items-center gap-2 text-xs text-zinc-400 bg-white/5 border border-white/5 p-2.5 rounded-lg">
