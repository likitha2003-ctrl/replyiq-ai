...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          "relative w-full max-w-lg rounded-xl border border-white/10 bg-slate-900/90 p-6 shadow-2xl backdrop-blur-md animate-scale-in text-white overflow-hidden max-h-[90vh] flex flex-col",
          className
        )}
      >
        {/* Glow header border */}
