...
export const ImageComparison = ({ beforeImage, afterImage, altBefore = 'Before', altAfter = 'After' }: any) => {
    ...
    return (
        <div 
            ref={containerRef}
            className="relative w-full max-w-5xl mx-auto select-none rounded-2xl overflow-hidden shadow-2xl border border-white/10"
